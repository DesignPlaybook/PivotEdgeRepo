...
// Drop each component into its own file as needed,
// or use this as a single-file reference.
// ============================================================
...
//     <section
//       ref={ref}
//       className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#123845]"
//     >
...
//         />
//         <div className="absolute inset-0 bg-gradient-to-b from-[#123845]/60 via-[#123845]/70 to-[#123845]" />
//       </motion.div>

//       {/* Decorative lines */}
//       <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
//         <div className="absolute top-0 left-1/2 -translate-x-1/2 w-px h-32 bg-gradient-to-b from-transparent to-[#C9A23F]/40" />
//         <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-px h-32 bg-gradient-to-t from-transparent to-[#C9A23F]/40" />
//         <div className="absolute top-1/2 left-0 -translate-y-1/2 w-32 h-px bg-gradient-to-r from-transparent to-[#C9A23F]/30" />
//         <div className="absolute top-1/2 right-0 -translate-y-1/2 w-32 h-px bg-gradient-to-l from-transparent to-[#C9A23F]/30" />
//         {/* Ornamental rings */}
//         <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] border border-[#C9A23F]/5 rounded-full" />
//         <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] border border-[#C9A23F]/5 rounded-full" />
//       </div>
...
//           className="text-[#C9A23F] uppercase tracking-[0.4em] text-xs md:text-sm mb-8 font-light"
//         >
...
//           className="w-24 h-px bg-[#C9A23F]/60 mx-auto mb-8"
//         />
...
//           className="text-white/60 max-w-2xl mx-auto text-base md:text-lg leading-[1.9] font-light mb-12"
//         >
...
//         >
//           {/* Primary CTA */}
//           <button className="group relative px-8 py-4 bg-[#C9A23F] text-white text-sm tracking-[0.2em] uppercase font-medium overflow-hidden transition-all duration-300 hover:shadow-[0_0_40px_rgba(201,162,63,0.4)]">
...
//           {/* Secondary CTA — scrolls to HowWeWork */}
//           <button
//             onClick={scrollToHowWeWork}
//             className="group px-8 py-4 border border-white/20 text-white/80 text-sm tracking-[0.2em] uppercase font-light hover:border-[#C9A23F]/60 hover:text-[#C9A23F] transition-all duration-300"
//           >
//             View Our Approach
...
//           className="mt-20 grid grid-cols-3 divide-x divide-white/10 max-w-xl mx-auto"
//         >
//           {[
//             { val: "200+", label: "CEO Mandates" },
//             { val: "18", label: "Industries" },
//             { val: "96%", label: "Retention Rate" },
//           ].map((s, i) => (
//             <div key={i} className="px-6 text-center">
//               <p
//                 className="text-2xl md:text-3xl font-light text-[#C9A23F]"
...
//           className="w-px h-8 bg-gradient-to-b from-[#C9A23F]/60 to-transparent"
//         />
//       </motion.div>
//     </section>
//   );
...
export const ServicesSection = () => {
  ...
  return (
    <section
      id="services"
      className="py-24 md:py-32 bg-[#123845] relative overflow-hidden"
    >
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,#C9A23F10,transparent_60%)]" />
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 mb-16">
          ...
          <motion.p
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className="text-white/50 max-w-sm text-[14.5px] leading-[1.9] font-light md:text-right"
          >
          ...
          {services.map((svc, i) => (
            ...
            >
              ...
              <div className="absolute inset-0">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#123845] via-[#123845]/70 to-[#123845]/30" />
              </div>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 z-10">
                ...
                <p className="text-white/60 text-[13.5px] leading-[1.75] font-light opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-500">
                  {svc.description}
                </p>
              </div>
    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="relative">
          ...
          {/* <div className="hidden md:block absolute top-[52px] left-[10%] right-[10%] h-px bg-gradient-to-r from-transparent via-[#C9A23F]/30 to-transparent" /> */}
...
export const DomainsSection = () => {
  return (
    <section className="py-24 md:py-32 bg-[#123845] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="mt-6 max-w-2xl mx-auto text-white/50 text-[15px] leading-[1.9] font-light">
        ...
        >
          <p className="text-white/40 text-sm leading-[1.9] font-light max-w-3xl mx-auto">
            Our functional expertise spans{" "}
            <span className="text-[#C9A23F]/70">
  ...
  return (
    <div style={{ fontFamily: "'Lato', sans-serif" }}>
      ...
      <style>{`
        ...
        .domains-scroll::-webkit-scrollbar { height: 4px; }
        .domains-scroll::-webkit-scrollbar-track { background: transparent; }
        .domains-scroll::-webkit-scrollbar-thumb { background: #C9A23F44; border-radius: 2px; }
      `}</style>
